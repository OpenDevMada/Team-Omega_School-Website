...
public interface EnrollmentRepository extends JpaRepository<Enrollment, EnrollmentId> {
    ...
    Page<Enrollment> findByStudentRegistrationAndTeacherId(String registrationNumber, String teacherId,
            Pageable pageable);

    @Query("SELECT e FROM Enrollment e WHERE e.course.title = :title AND e.course.teacher.userId = :teacherId")
    Page<Enrollment> findByCourseTitleAndTeacherId(String title, String teacherId, Pageable pageable);
