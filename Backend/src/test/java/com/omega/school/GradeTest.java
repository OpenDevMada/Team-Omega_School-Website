...
@DataJpaTest
@AutoConfigureTestDatabase(replace = AutoConfigureTestDatabase.Replace.NONE) // ← pour utiliser ta base Postgres réelle
public class GradeTest {
    ...
    void testSaveAndReadGrade_withCompositeId() {
        ...
        List<Grade> byStudent = gradeRepository.findByStudent_UserId(student.getUserId());
        ...
        List<Grade> byCourse = gradeRepository.findByCourse_CourseId(course.getCourseId());
