      ...
      <AlertDialogTrigger asChild>
        {mode === "create" ? (
          <Button className="bg-(--yellow) hover:bg-yellow-500 text-white shadow-sm">
            <BookPlus className="w-4 h-4 mr-2" /> Ajouter un cours
          </Button>
        ) : (
        ...
        <AlertDialogHeader>
          <div className="flex justify-between items-start w-full">
            <div>
              ...
              <AlertDialogDescription>
                {mode === "create"
                  ? "Renseignez les informations du cours."
        ...
        <Form {...form}>
          ...
          >
            ...
            <div className="flex justify-end gap-3 pt-2">
              ...
              <Button
                type="submit"
                className="bg-(--yellow) hover:bg-yellow-500 text-white"
              >
                {pending ? (
                  mode === "create" ? (
                    <>
