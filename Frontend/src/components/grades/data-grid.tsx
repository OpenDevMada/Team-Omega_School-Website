...
import { BookCheck, CalendarDays, MessageSquareText } from "lucide-react";
      ...
      {grades.length > 0 ? (
        ...
        <div className="col-span-full">
          <Empty>
            ...
            <EmptyContent>
              <EmptyTitle>0 notes</EmptyTitle>
              <EmptyDescription>Vous n'avez pas encore obtenu de note pour le moment.</EmptyDescription>
            </EmptyContent>
          </Empty>
        </div>
      )}
