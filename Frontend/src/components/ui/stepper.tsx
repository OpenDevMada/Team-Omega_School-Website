...
function StepperIndicator(props: StepperIndicatorProps) {
  ...
  return (
    <IndicatorPrimitive
      ...
      ref={ref}
      className={cn(
        "flex size-7 shrink-0 items-center justify-center rounded-full border-2 border-muted bg-background font-medium text-muted-foreground text-sm transition-colors data-[state=active]:border-(--yellow) data-[state=completed]:border-(--yellow) data-[state=active]:bg-(--yellow) data-[state=completed]:bg-(--yellow) data-[state=active]:text-primary-foreground data-[state=completed]:text-primary-foreground",
        className,
      )}
    >
...
function StepperSeparator(props: StepperSeparatorProps) {
  ...
  return (
    <SeparatorPrimitive
      ...
      ref={ref}
      className={cn(
        "bg-border transition-colors data-[state=active]:bg-(--yellow) data-[state=completed]:bg-(--yellow)",
